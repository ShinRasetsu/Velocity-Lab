...
## Perfection Bar
Every live value at 60Hz, never GPS-rate stairs. See `.opencode/skills/perfection-audit/SKILL.md` 8 gates (project-matched, Gate 8 live Playwright).
...
2. `/audit` must show `Perfection verdict: PASS` (all 8 gates, Gate 8 SKIP allowed if no playwright). `/audit-fluidity` for quick Gate 1.

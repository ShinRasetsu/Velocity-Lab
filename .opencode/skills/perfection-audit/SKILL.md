...
- **Accuracy:** `GPS_STALE_MS` (done 8000), altitude lift in `gpsConfidence` (done +0.15 <12m), `FUSION_GPS_WEIGHT` adapt >5Hz (done), `crossFraction` linear vs quadratic (`index.html:1602`), creep gate (done 0.3 high-conf)
